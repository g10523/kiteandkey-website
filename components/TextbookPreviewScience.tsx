// components/TextbookPreviewScience.tsx
"use client";
...
export default function TextbookPreviewScience() {
        ...
        <section className="py-28 bg-gradient-to-b from-white via-[#FAFBFF] to-[#F7F5FB] border-t border-[#E6E1F2]">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="grid gap-16 lg:grid-cols-2 items-center">
                    ...
                    {/* Right: Content - Science-specific */}
                    <div>
                        <h3 className="text-3xl md:text-4xl font-bold text-[#3F3A52] tracking-tight mb-6">
                            Designed for scientific understanding
                        </h3>

                        <p className="text-lg text-[#6B647F] leading-relaxed mb-8">
                            Our Science materials build conceptual understanding through clear
                            explanations, diagrams, and experiments that develop scientific literacy.
                        </p>

                        {/* Features grid - Science-specific */}
                        <div className="space-y-4 mb-10">
                            {[
                                {
                                    icon: Eye,
                                    label: "Visual diagrams",
                                    description: "Clear scientific diagrams and illustrations that explain complex processes and systems"
                                },
                                {
                                    icon: FileText,
                                    label: "Practical investigations",
                                    description: "Hands-on experiments with clear methods, safety notes, and analysis frameworks"
                                },
                                {
                                    icon: CheckCircle,
                                    label: "Concept progression",
                                    description: "From observation to explanation to application, building scientific thinking systematically"
                                },
                                {
                                    icon: Layout,
                                    label: "Clear terminology",
                                    description: "Scientific vocabulary introduced with definitions, examples, and contextual usage"
                                },
                            ].map((item) => (
                                <div
                                    key={item.label}
